...
After downloading, you can verify the file matches the published checksum on the [latest release page](https://github.com/Tchuekam/tchuekam-desktop/releases/latest).
